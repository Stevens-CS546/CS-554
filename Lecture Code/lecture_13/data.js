...
const chemex = {
    ...
    imageAttribution: "https://pixabay.com/en/chemex-coffee-filterk%C3%A1v%C3%A9-1247169/",
    ingredients: [
        {
            displayTitle: "Coffee",
            systemTitle: "coffee",
...
const oatmeal = {
    id: 1,
    imageAttribution: "https://pixabay.com/en/berries-bowl-breakfast-food-fruit-1839515/",
    title: "Oatmeal",
...
const eggsDeGastone = {
    id: 2,
    imageAttribution: "https://pixabay.com/en/egg-chicken-eggs-raw-eggs-eggshell-1510449/",
    title: "Eggs de Gastone",
    description: "When I was a lad I ate four dozen eggs. Every morning to help me get large. And now that I'm grown I eat five dozen eggs. So I'm roughly the size of a barge!",
    ingredients: [
        {
            displayTitle: "Eggs",
            systemTitle: "eggs",
    ...
    steps: [
        "Prepare one egg to liking",
        "Prepare 59 more eggs to liking"
    ]
};

const baconEggAndCheese = {
    id: 3,
    imageAttribution: "https://pixabay.com/en/beef-food-cheese-cucumber-bacon-1204649/",
    title: "Bacon, Egg, and Cheese",
    description: "Life Hack: Make this low carb by not eating the bagel you desperately want to include in this meal!",
    ingredients: [
        {
            displayTitle: "Eggs",
            systemTitle: "eggs",
...
const lavaCake = {
    ...
    title: "Lava Cake",
    description: "This is a secret recipe; only students whom receive an A and request it specially will be given the lava cake recipe.",
    ingredients: [],
    steps: []
};

const recipeList = [chemex, oatmeal, eggsDeGastone, baconEggAndCheese, lavaCake].map(Recipe);
